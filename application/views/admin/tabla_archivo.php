		<div id="content">
		<ul class="breadcrumb">
	<li><a href="<?php echo base_url(); ?>admin" class="glyphicons home"><i></i> Plus</a></li>
	<li class="divider"></li>
	<li>Archivos</li>
</ul>
			...
			<table class="dynamicTable table table-striped table-bordered table-primary table-condensed checkboxs">
                ...
                <?php foreach($archivo as $row): ?>
					<tr class="selectable">
                        ...
                        <td class="center">
						<a href="<?php echo base_url();?>admin_archivo/archivo_id/<?php echo $row->archivo_id; ?>" class="btn-action glyphicons pencil btn-success"><i></i></a>
