			...
			<ul class="topnav pull-right">
				...
				<li class="account">
					...
					<ul class="dropdown-menu pull-right">
						...
						<li>
							<span>
								<a class="btn btn-default btn-small pull-right" style="padding: 2px 10px; background: #fff;" href="login.html?lang=en">Salir</a>
							</span>
						</li>
					</ul>
					  </li>
...
<ul>
    ...
    <li class="glyphicons coins"><a href="<?php echo base_url(); ?>admin/index/finances"><i></i><span>Finanzas</span></a></li>
    <li class="hasSubmenu">
        <a data-toggle="collapse" class="glyphicons shopping_cart" href="#menu_ecommerce"><i></i><span>Tienda</span></a>
        <ul class="collapse" id="menu_ecommerce">
            <li class=""><a href="<?php echo base_url(); ?>admin//index/products"><span>Productos</span></a></li>
            <li class=""><a href="<?php echo base_url(); ?>admin/index/product_edit"><span>Add productos</span></a></li>
        </ul>
    </li>
