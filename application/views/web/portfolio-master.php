        ...
        <div class="container"> <a href="index.html" class="brand"><img src="images/main-logo.png" alt="himalaya"/></a>
          <nav id="mainMenu">
            <ul>
              ...
              <li><a href="portfolio-vertical.html" class="firstLevel active">Portfolio</a>
                <ul>
              ...
              <li><a href="blog-home-sidebar-right.html" class="firstLevel">Blog</a>
                <ul>
          ...
          <section id="page">
            <header class="page-header">
              <div class="container">
                <div class="row">
                  <div class="span12">
                    <h1>Portfolio<small> / Single project Image</small></h1>
                  </div>
                </div>
              </div>
            </header>
              ...
              <div class="container">
                <div class="row">
                  <div class="span8">
                    ...
                    <img src="images/theme-pics/single-portfolio.jpg" alt="snowflake premium website template"/>
                  ...
                  <div class="span4">
                    ...
                    <h2 class="standardTitle"><span>Check out this amazing stuff we've done</span></h2>
                    <h3>Client</h3>
                    <p>Big International Company</p>
                    <h3>Technology</h3>
                    <p>HTML5, CSS3, Bootstrap</p>
                    <div id="shareme" data-url="http://themeforest.net/item/ohmy-html5-css3-bootstrap-website-template/full_screen_preview/3589661?ref=Little-Neko" data-text="Check out this great #themeforest item 'OHMY! HTML5, CSS3, Bootstrap website template"> </div>
                  </div>
                </div>
              </div>
            </section>
            <section>
              <div class="container clearfix" id="otherProjects">
                ...
                <div class="row">
                  <div class="span12">
                    <h3>Other works in this category</h3>
                  </div>
                </div>
                ...
                <div class="row  da-thumbs">  
                  ...
                  <article class="span4 ">
                    ...
                    <a href="images/portfolio/vign2.jpg" class="prettyPhoto">
                      <section class="imgWrapper"> <img src="images/portfolio/vign2.jpg" alt=""/></section>
                      <div> 
                        <span class="iconWrapper iconLink">
                    ...
                    <section class="mt15">
                      ...
                      <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vulputate nunc ut tellus sollicitudin placerat. Sed ac consectetur leo. Pellentesque habitant morbi tristique senectus et netus... <br>
                    ...
                    <article class="span4 ">
                      ...
                      <a href="images/portfolio/vign5.jpg" class="prettyPhoto">
                      ...
                      <article class="span4">
                        ...
                        <a href="images/portfolio/vign9.jpg" class="prettyPhoto">
...
<!-- End Document 
  ...
  <script src="js-plugin/camera/camera.min.js" type="text/javascript"></script>
  <script type="text/javascript" src="js-plugin/pretty-photo/js/jquery.prettyPhoto.js"></script>
