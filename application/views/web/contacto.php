                            ...
                            <section>
                                ...
                                <div class="container">
                                    <div class="row"> 
                                        ...
                                        <div class="span5">
  <!-- map -->
                                <div class="imgWrapper"><div id="mapWrapper"></div>  </div>
                                <!-- map -->    
                                        ...
                                        <div class="span4">
                                            ...
                                            <form method="post" action="<?php echo base_url(); ?>assets-web/js-plugin/neko-contact-ajax-plugin/php/form-handler.php" id="contactfrm">
                                                ...
                                                <fieldset class="clearfix securityCheck">
                                                    ...
                                                    <div class="row">
                                                        <div class="span4 pull-left humanCheck">
                                                            <label for="verify" class="pull-left"><img src="js-plugin/neko-contact-ajax-plugin/php/image.html" alt="Image verification"/></label>
